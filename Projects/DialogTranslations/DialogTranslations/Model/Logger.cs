...
namespace DialogTranslations.Model
{
    public class Logger
    {
        ...
        static void InitializeLogger(string fileLocation)
        {
            ...
            var roller = new RollingFileAppender
            {
                ...
                File = Path.Combine(GetLicenseFileFolder(fileLocation), "DialogTranslations.log")
            };
        ...
        public static ILog Create(string fileLocation)
        {
            if (!_logInitialized)
            {
                InitializeLogger(fileLocation);
                _logInitialized = true;
            }

            return LogManager.GetLogger("DialogTranslations");
        }
    }
}
